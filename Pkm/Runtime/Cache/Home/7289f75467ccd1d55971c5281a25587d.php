...
<link rel="stylesheet" type="text/css" href="/PKM2.0/Public/css/basic.css" /><link rel="stylesheet" type="text/css" href="/PKM2.0/Public/css/friend.css" />
<script type="text/javascript" src="/PKM2.0/Public/js/jquery_min.js"></script><script type="text/javascript" src="/PKM2.0/Public/js/basic.js"></script><script type="text/javascript" src="/PKM2.0/Public/js/friend_show.js"></script>
</head>
<body>
...
<div id="screen"></div>
	...
	<div id="foot">
	<?php switch($flag): case "0": ?><p style="margin:10px;" class="plogin">对不起，您还没有登陆...</p><?php break;?>
		<?php case "1": ?><div class="nav">
			这里添加导航
		</div>
		<div class="fleft">
			<h2>我的好友</h2>		
			<?php if(is_array($friendData)): $i = 0; $__LIST__ = $friendData;if( count($__LIST__)==0 ) : echo "您还没有好友，赶快添加吧..." ;else: foreach($__LIST__ as $key=>$myfriend): $mod = ($i % 2 );++$i;?><div class="myf">		
				<img src="/PKM2.0/Public/photo/user_normal.jpg" alt="好友" width="48px" height="48px"/>
				<dl>
					<dt><a href="###"><?php echo (stripslashes($myfriend["user"])); ?></a><span>日志（0）</span><span>提问（0）</span></dt>
					<dd>简介：<?php echo (stripslashes($myfriend["ps"])); ?></dd>
					<dd>最近状态：<?php echo ($myfriend["state"]["0"]["text"]); ?></dd>
					<dd class="ftag">标签：<a href="###">电脑</a><a href="###">软件</a></dd>
				</dl>
			</div><?php endforeach; endif; else: echo "您还没有好友，赶快添加吧..." ;endif; ?>
			
		</div>
		<div class="fright">
			<h2>好友推荐</h2>
			<?php if(is_array($RecUser)): $i = 0; $__LIST__ = $RecUser;if( count($__LIST__)==0 ) : echo "随便逛逛，寻找志同道合的朋友吧..." ;else: foreach($__LIST__ as $key=>$userValue): $mod = ($i % 2 );++$i;?><div class="recf">		
				<img src="/PKM2.0/Public/photo/user_normal.jpg" alt="好友" width="48px" height="48px"/>
				<dl>
					<dt><a href="###" class="recuser"><?php echo (stripslashes($userValue["user"])); ?></a><span title="加为好友" class="addf">好友</span></dt>
					<dd title="<?php echo (stripslashes($userValue["ps"])); ?>">简介：<?php echo (mb_substr(stripslashes($userValue["ps"]),0,14,'UTF-8')); ?></dd>
					<dd class="ftag">标签：<a href="###">电脑</a><a href="###">软件</a></dd>
				</dl>
			</div><?php endforeach; endif; else: echo "随便逛逛，寻找志同道合的朋友吧..." ;endif; ?>
