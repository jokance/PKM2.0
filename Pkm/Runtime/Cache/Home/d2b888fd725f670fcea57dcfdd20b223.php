...
<link rel="stylesheet" type="text/css" href="/PKM2.0/Public/css/bootstrap_min.css" /><link rel="stylesheet" type="text/css" href="/PKM2.0/Public/css/basic.css" /><link rel="stylesheet" type="text/css" href="/PKM2.0/Public/css/diary_write.css" />
<script type="text/javascript" src="/PKM2.0/Public/js/jquery_min.js"></script><script type="text/javascript" src="/PKM2.0/Public/js/bootstrap_min.js"></script><script type="text/javascript" src="/PKM2.0/Public/js/basic.js"></script>
</head>
<body>	
<div id="main">
	<!-- 引入公共模板 -->
...
<div id="screen"></div>
	...
	<div id="foot">
		...
		<div class="diary">
		<?php if(empty($_COOKIE['user'])): ?><p class="text-warning">您还没有登录呢...</p><?php endif; ?>
			<h3>我的日志<small> —— 写日志</small></h3>
			<form role="form" name="diary">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="tag" id="tag" placeholder="标签之间使用逗号隔开">
				  </div>
				  <div class="form-group">
				   	<label for="abstract">Abstract</label>
				  	<textarea class="form-control" rows="3" name="abstract" id="abstract"></textarea>
				  </div>
				  <div class="form-group">
		...
		<div class="bottom">
			<p class="text-center">This page powered by <a href="http://www.bootcss.com" target="_blank">Bootstrap</a></p>
		</div>
	</div>
</div>
</body>
